...
class CategoryOptionSearchMapper extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div>
                {this.checkType('SELECT').length > 0 ? <div><CategoryOptionSearchSELECT aggs={this.props.aggs} optionFilter={this.props.optionFilter} catOptionId={this.props.cat_option_id} onChange={this.props.onChange} catOptions={this.props.catOptions} catOptionsTemp={this.checkType('SELECT')[0]}></CategoryOptionSearchSELECT></div> :
                    this.checkType('MULTI_SELECT').length > 0 ? <div><CategoryOptionSearchMULTISELECT aggs={this.props.aggs} optionFilter={this.props.optionFilter} catOptionId={this.props.cat_option_id} onChange={this.props.onChange} catOptions={this.props.catOptions} catOptionsTemp={this.checkType('MULTI_SELECT')[0]}></CategoryOptionSearchMULTISELECT></div> :
                        this.checkType('SINGLE').length > 0 ? <div><CategoryOptionSearchSINGLE onReset={ this.props.onReset}aggs={this.props.aggs} optionFilter={this.props.optionFilter} catOptionId={this.props.cat_option_id} onChange={this.props.onChange} catOptions={this.props.catOptions} catOptionsTemp={this.checkType('SINGLE')[0]}></CategoryOptionSearchSINGLE></div> :
