...
export default class DictionaryDTO extends BaseDTO {
  ...
  validation(state) {
    ...
    validator(state.type).display("type").required().isString().isIn([ConstValues.CODE.INFO, ConstValues.CODE.VALIDATION, ConstValues.CODE.WARNING, ConstValues.CODE.LABEL, ConstValues.CODE.SUCCESS, ConstValues.CODE.PLACEHOLDER, ConstValues.CODE.ERROR_GLOBAL, ConstValues.CODE.INFO_GLOBAL, ConstValues.CODE.SUCCESS_GLOBAL, ConstValues.CODE.WARNING_GLOBAL, ConstValues.CODE.EMAIL]);
...
;
//# sourceMappingURL=DictionaryDTO.js.map