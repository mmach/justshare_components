...
export default class CategoryOptionsDTO extends BaseDTO {
  ...
  validation(state) {
    ...
    */
    ...
    validator(state.cot_id).display("cot_id").isString().notEmpty(); //validator(state.surname).display("surname").isString().notEmpty();

    return validator.run();
  }

}
//# sourceMappingURL=CategoryOptionsDTO.js.map