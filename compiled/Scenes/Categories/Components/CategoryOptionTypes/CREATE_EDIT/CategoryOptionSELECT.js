...
class CategoryOptionSELECT extends React.Component {
  ...
  render() {
    ...
    return React.createElement(Container, {
      ...
      onChange: event => {
        this.state.catOption.order = Number(event.target.value);
        this.refreshValidation();
        this.setState({
          catOption: this.state.catOption
        });
    ...
    }), this.state.catOption.status == 1 ? React.createElement(FormGroup, null, React.createElement(Col, {
    ...
    }, tran.translate('CATEGORY_OPTION_DETAILS_HEADER')), React.createElement("br", null), React.createElement(Button, {
      disabled: this.state.catOption.category_id != undefined && this.state.catOption.category_id != this.props.category_id,
      onClick: this.addNewOption.bind(this),
      className: "btn g-letter-spacing-1 g-font-weight-700 g-font-size-12 text-uppercase rounded-0"
    }, tran.translate('CATEGORY_OPTION_ADD_NEW_SELECT_OPTION'))), React.createElement(ListGroup, null, this.props.catOption.cat_opt_temp ? this.props.catOption.cat_opt_temp.map(item => {
      ...
      return React.createElement(Collapsible, {
        ...
        lazyRender: true,
        trigger: item.value
      }, React.createElement(CategoryOptionSELECT_SINGLE, {
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryOptionSELECT);
//# sourceMappingURL=CategoryOptionSELECT.js.map