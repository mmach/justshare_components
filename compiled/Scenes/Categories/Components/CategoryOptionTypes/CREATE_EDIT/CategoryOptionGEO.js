...
class CategoryOptionGEO extends React.Component {
  constructor(props) {
    ...
    if (this.props.catOption.cat_opt_temp == undefined || this.props.catOption.cat_opt_temp.length == 0) {
      ...
      props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 5, "Miasto"), props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 6, "Miasto Id"), props.addEmptyElementOption(uuidv4(), this.state.catOption.id, 7, "Adres");
    }
  ...
  submitHanlder(event) {
    ...
    if (validator.length == 0) {
      ...
      if (this.state.catOption.cat_opt_temp == undefined) {
        this.state.catOption.cat_opt_temp = this.props.catOption.cat_opt_temp; //  this.state.catOption.cat_opt_temp.push({ id: uuidv4(), co_id: this.state.catOption.id, placeholder: 'NEW ELEMENT' })
  ...
  render() {
    ...
    return React.createElement(Container, {
      ...
      placeholder: phTrans.translate('OPTION_IS_SEARCHABLE_PLACEHOLDER'),
      isRequired: true,
      label: tran.translate('OPTION_IS_SEARCHABLE_LABEL'),
      value: this.state.catOption.is_searchable,
      onChange: event => {
        this.state.catOption.is_searchable = event.target.checked;
        this.refreshValidation();
        this.setState({
      ...
      placeholder: phTrans.translate('OPTION_IS_REQUIRE_PLACEHOLDER'),
      isRequired: true,
      label: tran.translate('OPTION_IS_REQUIRE_LABEL'),
      value: this.state.catOption.is_require,
      onChange: event => {
        this.state.catOption.is_require = event.target.checked;
        this.refreshValidation();
        this.setState({
          catOption: this.state.catOption
        });
      ...
      placeholder: phTrans.translate('OPTION_IS_ON_MAP_RESULT_PLACEHOLDER'),
      isRequired: true,
      label: tran.translate('OPTION_IS_ON_MAP_RESULT_LABEL'),
      value: this.state.catOption.is_on_map,
      onChange: event => {
        this.state.catOption.is_on_map = event.target.checked;
        this.refreshValidation();
        this.setState({
          catOption: this.state.catOption
        });
      ...
      placeholder: phTrans.translate('OPTION_IS_ON_MAP_TOOLTIP_PLACEHOLDER'),
      isRequired: true,
      label: tran.translate('OPTION_IS_ON_MAP_TOOLTIP_LABEL'),
      value: this.state.catOption.is_on_pin_map,
      onChange: event => {
        this.state.catOption.is_on_pin_map = event.target.checked;
        this.refreshValidation();
        this.setState({
          catOption: this.state.catOption
        });
      ...
      placeholder: phTrans.translate('OPTION_HIDE_IN_FORM_PLACEHOLDER'),
      isRequired: true,
      label: tran.translate('OPTION_HIDE_IN_FORM_LABEL'),
      value: this.state.catOption.is_form_hidden,
      onChange: event => {
        this.state.catOption.is_form_hidden = event.target.checked;
        this.refreshValidation();
        this.setState({
          catOption: this.state.catOption
        });
      ...
      placeholder: phTrans.translate('OPTION_LIMIT_OF_PLACEHOLDER'),
      isRequired: true,
      label: tran.translate('OPTION_LIMIT_OF_LABEL'),
      value: this.state.catOption.limit_of,
      onChange: event => {
        this.state.catOption.limit_of = event.target.value;
        this.refreshValidation();
        this.setState({
          catOption: this.state.catOption
        });
      ...
      placeholder: phTrans.translate('OPTION_ORDER_PLACEHOLDER'),
      isRequired: true,
      label: tran.translate('OPTION_ORDER_LABEL'),
      value: this.state.catOption.order,
      onChange: event => {
        this.state.catOption.order = event.target.value;
        this.refreshValidation();
        this.setState({
          catOption: this.state.catOption
        });
    ...
    }), this.state.catOption.status == 1 ? React.createElement(FormGroup, null, React.createElement(ListGroup, null, this.props.catOption.cat_opt_temp ? this.props.catOption.cat_opt_temp.map(item => {
      ...
      }, React.createElement(CategoryOptionGEO_SINGLE, {
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryOptionGEO);
//# sourceMappingURL=CategoryOptionGEO.js.map