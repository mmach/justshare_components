...
class CategoryOptionFormSINGLE extends React.Component {
  ...
  onChange(event) {
    ...
    this.props.onChange(this.props.catOption, this.state.catOption);
  }
  ...
  render() {
    ...
    return React.createElement("div", {
      className: "g-mb-10"
    }, ['FLOAT', 'STRING', 'NUMBER'].includes(this.props.catOption.cat_opt.name) ? React.createElement(TextBox, {
      ...
      field: "email",
      validation: []
    }) : React.createElement("span", null), ['DATE'].includes(this.props.catOption.cat_opt.name) ? React.createElement(DayPickerInputComponent, {
